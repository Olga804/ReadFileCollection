...
максимальное количество раз, если таких слов несколько, выводит все;
предусмотрен ввод абсолютного пути к файлу; работает только с латиницей;

Не делает: вывести частоту повторений встречающегося максимальное количество раз слова;
